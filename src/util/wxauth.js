    ...
    $ajax('/free/getWeChatInfo',{url:url},function(res){
        if(res.status === '1'){
            ...
            if(getQueryString('state') == '1'){
                ...
                let url=`${config.indexUri}?storeId=`+getQueryString('storeId')+'&activityId='+getQueryString('activityId')
                ...
                // window.location.href = `https://activities.sanqimei.com/get-weixin-code.html?appid=${data.appId}&redirect_uri=http%3a%2f%2f192.168.88.204%3a3000%2fwxpurchase%2fwxcenter%2fbuild%2flist%3fstoreId%3d54%26activityId%3d45&scope=snsapi_userinfo&connect_redirect=1&state=1`
            }
